									...
									<form method="post">
										<div class="row form-row">
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label>Name</label>
													<input type="text" name="name" class="form-control" value="<?php echo htmlentities($data['patient_name']);?>">
												</div>
											</div>
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label>Age</label>
														<input type="number" name="age" class="form-control" value="<?php echo htmlentities($data['patient_age']);?>">
												</div>
                                            </div>
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													...
													<input type="email" name="email" class="form-control" value="<?php echo htmlentities($data['patient_email']);?>">
												</div>
                                            </div>
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label>Mobile</label>
													<input type="text" name="contact" class="form-control" value="<?php echo htmlentities($data['patient_contact_no']);?>" >
												</div>
                                            </div>
											...
											<div class="col-12">
												<div class="form-group">
												<label>Address</label>
													<input type="text" name="address" class="form-control" value="<?php echo htmlentities($data['patient_address']);?>">
												</div>
											</div>
										</div>
